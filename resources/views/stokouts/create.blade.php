...
@section('content')
    ...
    <div class="page-heading">
        <h1 class="page-title">Create Stokout</h1>
        <ol class="breadcrumb">
            <li class="breadcrumb-item">
                <a href="{{route('dashboard')}}"><i class="fa fa-home font-20"></i></a>
            </li>
            <li class="breadcrumb-item">Create Stokout</li>
        </ol>
    </div>

    @include('stokouts.form')
@endsection
...
@section('js')
    ...
    <script src="{{asset('assets/js/stokouts.js')}}" type="text/javascript"></script>
@endsection