...
class Product extends Model{
    ...
    protected $fillable = [
        'category_id', 'created_by', 'updated_by', 'product_name', 'product_code', 'quantity', 'dimensi', 'jenis', 'satuan', 'merek', 'warna', 'product_image', 'product_slug', 'min',
    ];
    ...
    public function purchases(){
        return $this->belongsToMany(Purchase::class, 'purchase_details')->withPivot('quantity');
    }
